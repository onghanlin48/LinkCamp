...
public class Upload_IC_Front extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_ic_front);
        ...
        BtnAlready.setOnClickListener(v -> {
            register.clear();
            Intent intent = new Intent(Upload_IC_Front.this,login_page.class);
        ...
        BtnFront.setOnClickListener(v -> {
            ImagePicker.with(Upload_IC_Front.this)
                    .crop()
                    .compress(1024)
        ...
        btnNext.setOnClickListener(v -> {
            if(imageFront != null){
                register.setIc_front(imageFront);
                Intent intent = new Intent(Upload_IC_Front.this,Upload_IC_Back.class);
                startActivity(intent);
                finish();
            }else{
                example.setTextColor(ColorStateList.valueOf(Color.RED));
                example.setText("Please Upload Front of IC!");
            }
        });
