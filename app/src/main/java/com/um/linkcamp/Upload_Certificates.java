...
public class Upload_Certificates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(Upload_Certificates.this);
        ...
        BtnAlready.setOnClickListener(v -> {
            register.clear();
            Intent intent = new Intent(Upload_Certificates.this,login_page.class);
            startActivity(intent);
            finish();
        });
        db = FirebaseFirestore.getInstance();
        DocumentReference docRef = db.collection("Example").document("Certificates");
        ...
        TextView mutli = findViewById(R.id.multiply);
        ...
        btnNext.setOnClickListener(v -> {
            if(c != null){
                ...
                Intent intent = new Intent(Upload_Certificates.this,Upload_profile.class);
                startActivity(intent);
                finish();
